                            ...
                            <?php foreach ($tasks as $task): ?>
                                <tr>
                                    ...
                                    <td class="actions-col">
                                        <button class="action-btn" onclick="openAssignModal('<?= htmlspecialchars($task['booking_id']) ?>', '<?= htmlspecialchars($task['fullName']) ?>', '<?= htmlspecialchars($task['pickupLocation']) ?>', '<?= htmlspecialchars($task['destination']) ?>', '<?= htmlspecialchars($task['vehicleType']) ?>', '<?= htmlspecialchars($task['pickupDate']) ?>')">
