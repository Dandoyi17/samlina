...
$sql = "SELECT
        ...
        WHERE COALESCE(h.task_assign_status, h.status) = 'completed'
    ...
    <main class="page-container">
        <section class="card">
            <div class="card-header">
                ...
                <p class="muted small">Showing <span id="totalCount"><?= intval($totalCount) ?></span> completed tasks</p>
            </div>
            ...
            <div class="table-wrap">
                <table id="tasksTable" class="responsive-table">
                    ...
                    <tbody>
                        <?php if (empty($rows)): ?>
                            <tr>
                                <td colspan="8" style="text-align:center;padding:1rem;color:#666;">No completed tasks found</td>
                            </tr>
                        <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td class="actions-col">
                                        ...
                                        <?php if (!empty($row['driver_name'])): ?>
                                            <a class="btn" style="margin-left:.4rem" href="ratings_detail.php?driver_id=<?= intval($row['hire_pk'] ? $row['hire_pk'] : 0) ?>" title="View ratings">
